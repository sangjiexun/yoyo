...
import yoyo.framework.enterprise.infra.messaging.MailServiceImpl;
...
public class MailServiceImplTest {
    ...
    public final void testSend() throws EnterpriseException {
        testee.send("yoyo.framework@gmail.com", "nilcy@mac.com", "test subject", "object body",
            "text/plain");
        testee.send("yoyo.framework@gmail.com", "nilcy@mac.com", "test subject", "text body");
        testee.send("yoyo.framework@gmail.com", "nilcy@mac.com", "test subject",
            new MimeMultipart());
    }
}
